...
```{r, fig.height=4, fig.align='center', fig.cap='Distribution of averages of iid random variables in coin flip', echo = FALSE, outwidth = "100%"}
ottrpal::include_slide("https://docs.google.com/presentation/d/1U1PiqeXG4XoKmg8hRFJqE1OFDOJfificBz1jLeDunHo/edit#slide=id.g257d7b8e795_0_104")
```
...
```{r,fig.height=4, fig.align='center', fig.cap='Coverage of confidence intervals for coin flips, n=20', echo = FALSE, outwidth = "100%"}
ottrpal::include_slide("https://docs.google.com/presentation/d/1U1PiqeXG4XoKmg8hRFJqE1OFDOJfificBz1jLeDunHo/edit#slide=id.g257d7b8e795_0_107")
```
...
```{r,fig.height=4, fig.align='center', fig.cap='Coverage of confidence intervals for coin flips, n=100', echo = FALSE, outwidth = "100%"}
ottrpal::include_slide("https://docs.google.com/presentation/d/1U1PiqeXG4XoKmg8hRFJqE1OFDOJfificBz1jLeDunHo/edit#slide=id.g257d7b8e795_0_110")
```
...
```{r,fig.height=4, fig.align='center', fig.cap='Coverage of confidence intervals for coin flips, n=20, add 2 successes and 2 failures', echo = FALSE, outwidth = "100%"}
ottrpal::include_slide("https://docs.google.com/presentation/d/1U1PiqeXG4XoKmg8hRFJqE1OFDOJfificBz1jLeDunHo/edit#slide=id.g257d7b8e795_0_81")
```
...
```{r,fig.height=4, fig.align='center', fig.cap='Coverage of confidence intervals for Poisson data', echo = FALSE, outwidth = "100%"}
ottrpal::include_slide("https://docs.google.com/presentation/d/1U1PiqeXG4XoKmg8hRFJqE1OFDOJfificBz1jLeDunHo/edit#slide=id.g257d7b8e795_0_84")
```
...
```{r,fig.height=4, fig.align='center', fig.cap='Coverage of confidence intervals for Poisson data, t=1000', echo = FALSE, outwidth = "100%"}
ottrpal::include_slide("https://docs.google.com/presentation/d/1U1PiqeXG4XoKmg8hRFJqE1OFDOJfificBz1jLeDunHo/edit#slide=id.g257d7b8e795_0_122")
```
