...
```{r, fig.alt="Alternative text", fig.height=4, fig.align='center', fig.cap='Event A being sub section of B event', echo = FALSE, outwidth = "100%"}
ottrpal::include_slide("https://docs.google.com/presentation/d/1U1PiqeXG4XoKmg8hRFJqE1OFDOJfificBz1jLeDunHo/edit#slide=id.g256d730c400_0_1")
```
...
```{r, fig.alt="Alternative text", fig.height=4, fig.align='center', fig.cap='Events A and B with intersection', echo = FALSE, outwidth = "100%"}
ottrpal::include_slide("https://docs.google.com/presentation/d/1U1PiqeXG4XoKmg8hRFJqE1OFDOJfificBz1jLeDunHo/edit#slide=id.g25780f6af6f_0_0")
```
...
```{r, fig.alt="Alternative text", fig.height=4, fig.align='center', fig.cap='Area between 100-115 IQ under normal distribution', echo = FALSE, outwidth = "100%"}
ottrpal::include_slide("https://docs.google.com/presentation/d/1U1PiqeXG4XoKmg8hRFJqE1OFDOJfificBz1jLeDunHo/edit#slide=id.g25780f6af6f_0_3")
```
...
```{r, fig.alt="Alternative text", fig.height=4, fig.align='center', fig.cap='Shape of the density function for f(x)=2x', echo = FALSE, outwidth = "100%"}
ottrpal::include_slide("https://docs.google.com/presentation/d/1U1PiqeXG4XoKmg8hRFJqE1OFDOJfificBz1jLeDunHo/edit#slide=id.g257d7b8e795_0_1")
```
...
```{r, fig.alt="Alternative text", fig.height=4, fig.align='center', fig.cap='Shape of the density function for f(x)=2x', echo = FALSE, outwidth = "100%"}
ottrpal::include_slide("https://docs.google.com/presentation/d/1U1PiqeXG4XoKmg8hRFJqE1OFDOJfificBz1jLeDunHo/edit#slide=id.g257d7b8e795_0_5")
```
...
```{r, fig.alt="Alternative text", fig.height=4, fig.align='center', fig.cap='95 percentile of a distribution', echo = FALSE, outwidth = "100%"}
ottrpal::include_slide("https://docs.google.com/presentation/d/1U1PiqeXG4XoKmg8hRFJqE1OFDOJfificBz1jLeDunHo/edit#slide=id.g257d7b8e795_0_9")
```
...
```{r, fig.alt="Alternative text", fig.height=4, fig.align='center', fig.cap='Mean of a distribution', echo = FALSE, outwidth = "100%"}
ottrpal::include_slide("https://docs.google.com/presentation/d/1U1PiqeXG4XoKmg8hRFJqE1OFDOJfificBz1jLeDunHo/edit#slide=id.g257d7b8e795_0_16")
```
...
```{r, fig.alt="Alternative text", fig.height=4, fig.align='center', fig.cap='Height distribution for Childran and Parents', echo = FALSE, outwidth = "100%"}
ottrpal::include_slide("https://docs.google.com/presentation/d/1U1PiqeXG4XoKmg8hRFJqE1OFDOJfificBz1jLeDunHo/edit#slide=id.g257d7b8e795_0_22")
```
...
```{r, fig.alt="Alternative text", fig.height=4, fig.align='center', fig.cap='Height distribution for Childran', echo = FALSE, outwidth = "100%"}
ottrpal::include_slide("https://docs.google.com/presentation/d/1U1PiqeXG4XoKmg8hRFJqE1OFDOJfificBz1jLeDunHo/edit#slide=id.g257d7b8e795_0_25")
```
...
```{r, fig.alt="Alternative text", fig.height=4, fig.align='center', fig.cap='Expected value of a coin flip', echo = FALSE, outwidth = "100%"}
ottrpal::include_slide("https://docs.google.com/presentation/d/1U1PiqeXG4XoKmg8hRFJqE1OFDOJfificBz1jLeDunHo/edit#slide=id.g257d7b8e795_0_28")
```
...
```{r, fig.alt="Alternative text", fig.height=4, fig.align='center', fig.cap='Expected value of a die roll', echo = FALSE, outwidth = "100%"}
ottrpal::include_slide("https://docs.google.com/presentation/d/1U1PiqeXG4XoKmg8hRFJqE1OFDOJfificBz1jLeDunHo/edit#slide=id.g257d7b8e795_0_40")
```
...
```{r, fig.alt="Alternative text", fig.height=4, fig.align='center', fig.cap='Uniform density', echo = FALSE, outwidth = "100%"}
ottrpal::include_slide("https://docs.google.com/presentation/d/1U1PiqeXG4XoKmg8hRFJqE1OFDOJfificBz1jLeDunHo/edit#slide=id.g257d7b8e795_0_43")
```
...
```{r, fig.alt="Alternative text", fig.height=4, fig.align='center', fig.cap='Simulation example', echo = FALSE, outwidth = "100%"}
ottrpal::include_slide("https://docs.google.com/presentation/d/1U1PiqeXG4XoKmg8hRFJqE1OFDOJfificBz1jLeDunHo/edit#slide=id.g257d7b8e795_0_46")
```
...
```{r, fig.alt="Alternative text", fig.height=4, fig.align='center', fig.cap='Die roll simulation', echo = FALSE, outwidth = "100%"}
ottrpal::include_slide("https://docs.google.com/presentation/d/1U1PiqeXG4XoKmg8hRFJqE1OFDOJfificBz1jLeDunHo/edit#slide=id.g257d7b8e795_0_49")
```
...
```{r, fig.alt="Alternative text", fig.height=4, fig.align='center', fig.cap='Coin toss average', echo = FALSE, outwidth = "100%"}
ottrpal::include_slide("https://docs.google.com/presentation/d/1U1PiqeXG4XoKmg8hRFJqE1OFDOJfificBz1jLeDunHo/edit#slide=id.g257d7b8e795_0_52")
```
